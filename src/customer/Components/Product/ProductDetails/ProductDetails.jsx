...
const product = {
  ...
  href: "#",
  breadcrumbs: [
    { id: 1, name: "Apartment", href: "#" },
    { id: 2, name: "Cities", href: "#" },
  ],
  images: [
    {
      src: "",
    ...
    <div className="bg-white lg:px-20">
      <div className="pt-6">
              ...
              <form className="mt-10" onSubmit={handleSubmit}>
                ...
                <div className="mt-10">
                  <div className="flex items-center justify-between">
                    <h3 className="text-lg font-medium text-gray-900"> Wifi</h3>
                  </div>
        ...
        <section className="">
          ...
          <div className="border p-5">
            <Grid container spacing={7}>
              ...
              <Grid item xs={5}>
                <h1 className="text-xl font-semibold pb-1">Room Ratings</h1>
        ...
        <section className=" pt-10">
          <h1 className="py-5 text-xl font-bold">Similar Rooms</h1>
