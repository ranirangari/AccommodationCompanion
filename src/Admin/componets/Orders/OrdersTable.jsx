...
const OrdersTable = () => {
  ...
  return (
    <Box>
        ...
        <Grid container spacing={2}>
          <Grid item xs={4}>
            <FormControl fullWidth>
              ...
              >
                <MenuItem value={"PLACED"}>BOOKED</MenuItem>
                <MenuItem value={"CONFIRMED"}>CONFIRMED</MenuItem>
                <MenuItem value={"CANCELD"}>CANCELLED</MenuItem>
              </Select>
            </FormControl>
          </Grid>
          <Grid item xs={4}>
      ...
      {item.orderItems.map((orderItem)=><Avatar  alt={item.add} src={orderItem.product.imageUrl} /> )}
    </AvatarGroup>
                    {" "}
                  </TableCell>
                    ...
                    <Box sx={{ display: "flex", flexDirection: "column" }}>
                      ...
                      >
                        {item?.orderItems.map((order) => (
                          <span className=""> {order.product.brand},</span>
                        ))}
                      </Typography>
                    ...
                    <div>
                      ...
                      >
                        <MenuItem
                          ...
                          disabled={item.orderStatus==="SHIPPED" || item.orderStatus==="CONFIRMED"}
                        >
                          CONFIRMED ORDER
